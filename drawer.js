...
class Drawer {
    ...
    redrawTop(text, x, y, bgColor) {
        this.ctx.setTransform(1, 0, 0, 1, 0, 0);
        this.ctx.font = '100px notobk,Source Han Sans CN,sans-serif';
    ...
    redrawBottom(text, x, y, bgColor) {
        this.ctx.setTransform(1, 0, 0, 1, 0, 0);
        this.ctx.font = '100px notoserifbk,Source Han Serif SC,sans-serif';
    ...
    redrawImage(x, y, bgColor, callback) {
        this.ctx.setTransform(1, 0, 0, 1, 0, 0);
    ...
    getB64() {
        const width = Math.max(this.actualWidth.top, this.actualWidth.bottom);
        const height = this.ctx.canvas.height;
        return this.generator.getB64(width, height);
    }
}
